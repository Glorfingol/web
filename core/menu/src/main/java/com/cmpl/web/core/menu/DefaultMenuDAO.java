...
public class DefaultMenuDAO extends DefaultBaseDAO<Menu> implements MenuDAO {

  private final MenuRepository menuRepository;

  public DefaultMenuDAO(MenuRepository entityRepository, ApplicationEventPublisher publisher) {
