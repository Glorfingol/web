...
public class NewsEntryRequestValidatorImplTest {
  ...
  public void testValidateUpdate_Ok() {
    ...
    BDDMockito.doReturn(Arrays.asList()).when(validator).isIdValid(BDDMockito.eq(id), BDDMockito.eq(Locale.FRANCE));
    BDDMockito.doReturn(Arrays.asList()).when(validator).isNewsEntryValid(BDDMockito.eq(request),
        BDDMockito.eq(Locale.FRANCE));
    BDDMockito.doReturn(Arrays.asList()).when(validator).isContentValid(BDDMockito.eq(content),
        BDDMockito.eq(Locale.FRANCE));
    BDDMockito.doReturn(Arrays.asList()).when(validator).isNewsImageValid(BDDMockito.eq(image),
        BDDMockito.eq(Locale.FRANCE));
