...
public enum BACK_PAGE {
  ...
  WIDGET_VIEW("back/groups/edit_group", "back.widgets.title"),
  WIDGET_CREATE("back/groups/edit_group", "back.widgets.title"),
  WIDGET_UPDATE("back/groups/edit_group", "back.widgets.title"),
