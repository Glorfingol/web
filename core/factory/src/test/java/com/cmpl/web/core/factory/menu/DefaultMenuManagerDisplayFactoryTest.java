...
public class DefaultMenuManagerDisplayFactoryTest {
  ...
  @Spy
  @InjectMocks
  private DefaultMenuManagerDisplayFactory displayFactory;
  ...
  public void testComputeEntries_Empty() throws Exception {
    ...
    BDDMockito.given(menuService.getPagedEntities(BDDMockito.any(PageRequest.class)))
        .willReturn(page);
  ...
  public void testComputeModelAndViewForUpdateMenu() throws Exception {
    ...
    ModelAndView result = displayFactory
        .computeModelAndViewForUpdateMenu(Locale.FRANCE, "123456789");
