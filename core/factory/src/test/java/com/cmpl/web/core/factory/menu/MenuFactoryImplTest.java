...
public class MenuFactoryImplTest {
  ...
  public void testComputeMenuItemPageDTOMenuDTO() throws Exception {
    ...
    MenuDTO menu = MenuDTOBuilder.create().pageId("12345678").href("someHref").label("someLabel")
        .title("someTitle")
        .build();

    BDDMockito.doReturn(new ArrayList<>()).when(menuFactory)
        .computeSubMenuItems(BDDMockito.any(PageDTO.class),
            BDDMockito.any(MenuDTO.class));
    BDDMockito.doReturn("active").when(menuFactory)
        .computeCustomCssClass(BDDMockito.any(PageDTO.class),
            BDDMockito.any(MenuDTO.class));
  ...
  public void testComputeSubMenuItems() throws Exception {
    ...
    MenuDTO child = MenuDTOBuilder.create().parentId("12345678").href("someChildHref")
        .label("someChildLabel")
    ...
    MenuItem menuItem = MenuItemBuilder.create().href("someChildHref").label("someChildLabel")
        .title("someChildTitle")
