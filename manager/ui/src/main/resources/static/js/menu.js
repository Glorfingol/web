...
function postUpdateMenuForm() {
    ...
    update($("#menuEditForm"), $(".loader"), $(".card-loader"), url, urlFallback, menuToUpdate).done(function (data) {
        handleSuccessPutResult(data, $(".card-loader"), $(".loader"), $("#menuEditForm"), url)
    }).fail(function (error) {
...
function postCreateMenuForm() {
    ...
    create($("#menuCreateForm"), $(".loader"), $(".card-loader"), url, urlFallback, menuToCreate).done(function (data) {
        handleSuccessPostResult(data, $(".card-loader"), $(".loader"), $("#menuCreateForm"), url)
    }).fail(function (error) {
